...
namespace PokemonReviewApp.Controllers
{
    ...
    public class ReviewerController : Controller
    {
        ...
        [ProducesResponseType(400)]
        public IActionResult CreateReviewer([FromBody] ReviewerDto reviewCreate)
        {
            if (reviewCreate == null) { return BadRequest(); }

            var reviewer = _reviewerRepository.GetReviewers()
                .Where(c => c.LastName.Trim().ToUpper() == reviewCreate.LastName.TrimEnd().ToUpper())
                .FirstOrDefault();
            if (reviewer != null)
            {
            ...
            var reviewerMap = _mapper.Map<Reviewer>(reviewCreate);
        ...
        public IActionResult UpdateReviewer([FromQuery] int reviewerId,
